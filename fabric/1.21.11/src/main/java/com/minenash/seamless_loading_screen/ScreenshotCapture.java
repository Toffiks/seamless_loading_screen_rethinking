...
public final class ScreenshotCapture {
    ...
    public static void captureFrame() {
        ...
        try {
            ...
            ScreenshotRecorder.takeScreenshot(client.getFramebuffer(), image -> finishCapture(job, image));
    ...
    private static void runOnClientLater(Runnable action) {
        CompletableFuture.runAsync(() -> MinecraftClient.getInstance().execute(action));
    }
